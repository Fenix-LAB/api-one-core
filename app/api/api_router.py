...
router.include_router(company_data_controller.app, tags=["company_data_controller"], prefix="/DatosEmpresa")
router.include_router(requirements_controller.app, tags=["requirements_controller"], prefix="/Requerimientos")
